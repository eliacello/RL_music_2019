function [loglik, pout]= RL_fitmodel_conf1(params, data, choice)
...
% get behavioural data for configuration 1 

outcome = data.outcome (data.prep.conf==1);
outcome(outcome==0)=-1; 
outcome(outcome==1)=0; 
...
% output parameters
pout = struct('PP1s',PPs, 'VV1s', VVs, 'loglik1',loglik, ...
     'pe1', pe,  'params1',params,'data',data);
end
