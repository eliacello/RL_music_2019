function [loglik, pout]= RL_fitmodel_conf2(params, data, choice)
...
% get behavioural data for configuration 2 
outcome = data.outcome (data.prep.conf==2);
outcome(outcome==0)=-1; 
...
% output parameters
pout = struct('PP2s',PPs, 'VV2s', VVs, 'loglik2',loglik, ...
     'pe2', pe,  'params2',params,'data',data);
end
